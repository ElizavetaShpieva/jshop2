...
class Precondition2 extends Precondition
{
	...
	public Precondition2(Term[] unifier)
	{
		...
		p[4] = new PreconditionNegation(new PreconditionAtomic(new Predicate(9, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 2);
		b = new Term[5][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Precondition3 extends Precondition
{
	...
	public Precondition3(Term[] unifier)
	{
		...
		p[4] = new PreconditionNegation(new PreconditionAtomic(new Predicate(10, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier), 2);
...
class Method5 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal = new TaskList(2, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(4, 2, new TermList(new TermList(TermConstant.getConstant(9), new TermList(TermVariable.getVariable(0), TermList.NIL)), TermList.NIL)), false, true));
	...
	TaskList createTaskList1()
	{
		...
		retVal = new TaskList(2, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(4, 2, new TermList(new TermList(TermConstant.getConstant(10), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), TermList.NIL)), false, true));
		retVal.subtasks[1] = new TaskList(new TaskAtom(new Predicate(3, 2, TermList.NIL), false, false));
...
class Method6 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(4, 2, new TermList(new TermList(TermConstant.getConstant(10), new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(0), TermList.NIL))), TermList.NIL)), false, true));
...
class Method9 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[3] = new TaskList(new TaskAtom(new Predicate(5, 3, new TermList(new TermList(TermConstant.getConstant(10), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), TermList.NIL)), false, true));
...
class Precondition7 extends Precondition
{
	...
	{
		p = new Precondition[3];
		p[1] = new PreconditionAtomic(new Predicate(9, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier);
...
class Method10 extends Method
{
	...
	TaskList createTaskList1()
	{
		...
		retVal.subtasks[3] = new TaskList(new TaskAtom(new Predicate(5, 2, new TermList(new TermList(TermConstant.getConstant(9), new TermList(TermVariable.getVariable(0), TermList.NIL)), TermList.NIL)), false, true));
	...
	public Precondition getIterator(Term[] unifier, int which)
	{
		...
		{
			case 0:
				p = (new PreconditionAtomic(new Predicate(10, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier)).setComparator(null);
			break;
			case 1:
...
class Axiom0 extends Axiom
{
	public Axiom0()
	{
		super(new Predicate(11, 1, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(0), TermList.NIL))), 1);
	}
...
class Precondition9 extends Precondition
{
	...
	public Precondition9(Term[] unifier)
	{
		...
		p[3] = new PreconditionNegation(new PreconditionAtomic(new Predicate(11, 4, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier), 4);
		b = new Term[4][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Precondition13 extends Precondition
{
	...
	public Precondition13(Term[] unifier)
	{
		...
		p[3] = new PreconditionNegation(new PreconditionAtomic(new Predicate(11, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier), 4);
		b = new Term[4][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
public class blocks extends Domain
{
	public blocks()
	{
		...
		constants[8] = "block";
		constants[9] = "put-on-table";
		constants[10] = "stack-on-block";
		constants[11] = "same";
